export const darkTheme = {
    colors: {
      ...
      errorColor: '#f85149',
      loaderColor: '#58a6ff',
      selectBackground: '#0d1117',
      selectColor: '#c9d1d9',
      optionListBackground: '#24292f',
      optionListColor: '#c9d1d9',
      optionItemBackground: '#24292f',
      optionItemColor: '#ffffff',
      optionItemHoverBackground: '#21262d',
      optionItemHoverColor: '#58a6ff',
      optionItemDisabledBackground:'#0d1117',
      optionItemDisabledColor: '#f0f0f0',
      optionItemSelectedBackground: '#0d1117',
      optionItemSelectedColor: '#c9d1d9',
      optionItemPlayingBackground: '#c9d1d9',
      optionItemPlayingColor: '#0d1117',
    },
    scrollbar: {
        thumbColor: '#30363d',
        trackColor: '#21262d', 
