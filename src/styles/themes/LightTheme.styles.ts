export const lightTheme = {
    colors: {
      ...
      optionListColor: '#24292f',
      optionItemBackground: '#ffffff',
      optionItemColor: '#24292f',
      optionItemHoverBackground: '#f6f8fa',
      optionItemHoverColor: '#0969da',
      optionItemDisabledBackground:'#ffffff',
      optionItemDisabledColor: '#f0f0f0',
      optionItemSelectedBackground: '#ffffff',
      optionItemSelectedColor: '#0969da',
      optionItemPlayingBackground: '#c9d1d9',
      optionItemPlayingColor: '#ffffff',
